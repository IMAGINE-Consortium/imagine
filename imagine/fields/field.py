...
class GeneralField(object):
    ...
    subclassing GeneralField and overriding the `get_field` method. The
    ...
    The field produced by `get_field` will later accessed *indirectly* through
    the property `data` (see below).  Instances of new Field class should be
    generated by an accompanying :doc:`Field_Factory class <imagine.fields>`,
    derived from `imagine.fields.GeneralFieldFactory`.
    ...
    def get_field(self, parameters):
        ...
        See :doc:`code conventions <conventions>`.
        """
